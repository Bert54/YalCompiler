...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Jan 24 14:56:30 CET 2019
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$AnalyseurSyntaxique$act_num)
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.peek()).value;
		 EntreeVariable ev = new EntreeVariable(i, ileft + 1);
                   TDS.getInstance().ajouter(ev, new SymboleVariable(Valeurs.getInstance().getTaillePile()));
                   Valeurs.getInstance().empiler();
                   RESULT = new Declarer(ileft + 1, i, ev);
